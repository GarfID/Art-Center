package ru.garfid.artcenter.comment.model.logic.service
...
@Service
class CommentPermissionResolver() : BlockPermissionResolver {
    override val targetBlock: AuthorityBlockEnum = AuthorityBlockEnum.COMMENT
